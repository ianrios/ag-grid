...
import { LucideIconsConfigEditor } from './BordersConfigEditor';

export type BordersConfig = Required<BordersParams>;

export const bordersSchemeDefaultConfig: BordersConfig = {
  outside: true,
  belowHeaders: true,
  aboveFooters: true,
  betweenRows: true,
...
export const lucideIconsScheme: Scheme<BordersConfig> = {
  label: 'Lucide Icons',
  presets: [
    {
      id: 'skinny',
